{
  ...
  options.glaciux.keepassxc.enable = lib.mkEnableOption "keepassxc" // {default = true;};
  config = lib.mkIf config.glaciux.keepassxc.enable {
    ...
    programs.keepassxc = {
      ...
      settings = {
        General = {
          ...
          BackupFilePathPattern = "/home/callisto/Keepass/{DB_FILENAME}.old.kdbx";
